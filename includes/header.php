...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo getGlobalPath(); ?>assets/fonts/material-icon/material-icon.css">
    <link type="text/css" rel="stylesheet" href="<?php echo getGlobalPath(); ?>assets/css/materialize.min.css" media="screen,projection" />
    <link type="text/css" rel="stylesheet" href="<?php echo getGlobalPath(); ?>assets/css/style.css" />
    <link type="text/css" rel="stylesheet" href="<?php echo getGlobalPath(); ?>assets/css/jtable.css" />
    <link type="text/css" rel="stylesheet" href="<?php echo getGlobalPath(); ?>assets/css/plane.css" />
        ...
        <ul id="slide-out" class="sidenav sidenav-fixed">
            <li>
                <div class="center" style="height: 200px;">
                    <img src="<?php echo getGlobalPath(); ?>assets/images/head.png" width="70%">
                </div>
            </li>
            ...
            <li><a class="waves-effect red-text" href="../../auth/logout/"><i class="material-icons red-text">power_settings_news</i>Logout</a></li>
        </ul>
    </header>